...
public class NewsDaoImpl implements NewsDao {
    ...
    private final static String SQL_GET_SINGLE_NEWS_BY_AUTHORS = String.format("SELECT NEWS.N_ID, NEWS.N_MAIN_TITLE, NEWS.N_SHORT_TITLE, NEWS.N_DATE,NEWS.N_PHOTO,NEWS.N_THEME FROM NEWS JOIN NEWS_HAVE_AUTHORS ON NEWS_HAVE_AUTHORS.N_ID = NEWS.N_ID JOIN AUTHORS ON NEWS_HAVE_AUTHORS.ATR_ID = AUTHORS.ATR_ID WHERE AUTHORS.ATR_ID IN (?) AND NEWS.N_THEME = (?) GROUP BY (NEWS.N_ID, NEWS.N_MAIN_TITLE, NEWS.N_SHORT_TITLE ,NEWS.N_DATE,NEWS.N_PHOTO,NEWS.N_THEME)");
